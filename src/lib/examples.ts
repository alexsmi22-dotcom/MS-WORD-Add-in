...
export const MODE_EXAMPLES: Record<ExampleMode, string> = {
  ...
  solve: `
    ...
    <ul>
      ...
      <li><strong>Equation canvas:</strong> <em>Open equation canvas ⤢</em> pops the composer into a large window — the equation drawn big as you build it, the full palette at working size, and (for geometry) the composite figure drawn live. <em>Use this equation</em> brings it back to solve.</li>
