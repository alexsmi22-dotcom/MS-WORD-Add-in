...
export const MODE_EXAMPLES: Record<ExampleMode, string> = {
  ...
  citations: `
    ...
    <ul>
      <li><strong>Cases</strong> — <em>Alice Corp. v. CLS Bank Int'l</em>, 573 U.S. 208, 216 (2014); short form uses <code>at</code> (or <em>“→ Short form of this case”</em>). Type full party names — <em>Table T6</em> auto-abbreviates them (Corporation → Corp., International → Int’l).</li>
      <li><strong>Id. / supra</strong> — <em>Id.</em> at 217 for the immediately preceding cite; <em>supra</em> note 15, at 912 for an earlier source.</li>
