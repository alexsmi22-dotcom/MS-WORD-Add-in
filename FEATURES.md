...
- **Reference numerals** — number figure elements for callouts, so the spec can refer to them: block-diagram boxes get **hierarchical** numbers (100, 110, 112…), flowchart steps get 102, 104…, and a table figure gets a **numeral rail** (sections 100/200, rows 102/104…).
- **Insert as a figure** at the cursor — the graphic goes straight into your document as an image.
