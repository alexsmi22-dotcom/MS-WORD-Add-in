...
export const MODE_EXAMPLES: Record<ExampleMode, string> = {
  ...
  solve: `
    ...
    <ul>
      ...
      <li><strong>Equation composer:</strong> the palette under the input builds equations by click — fractions, powers, roots, functions — and the <strong>equation library</strong> loads classics (<code>F = m a</code>, <code>PV = nRT</code>, Pythagoras…) ready to solve for any symbol.</li>
